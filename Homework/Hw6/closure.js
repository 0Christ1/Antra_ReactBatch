// I tried to use this test file but I failed
// so I deleted all "export" keywords and
// then tested my function via test cases above it.
  ...
  return {
    ...
    run: (key, ...args) => {
      if (store[key]) {
        ...
        return `Function not found for the key ${key}.`;
      }
    },
  };
}
